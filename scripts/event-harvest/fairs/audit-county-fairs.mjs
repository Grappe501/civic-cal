...
function main() {
  ...
  if (verifiedDated < 30) issues.push(`Low verified dated county fairs: ${verifiedDated} (expected >= 30 after Pass 29C)`);
  if (approvedCount < 30) issues.push(`Low approved public fair events: ${approvedCount} (expected >= 30 after Pass 29C)`);
