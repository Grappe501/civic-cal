...
export const DISCOVERY_CHIPS: DiscoveryChipDef[] = [
  ...
  { id: "food_trucks", emoji: "🚚", label: "Food Trucks", tagline: "Food truck festivals, rallies & nights", modes: ["citizen", "organizer", "volunteer_seeker"], categories: ["food_truck_festival", "community", "small_business"], keywords: /food truck|food-truck|food truck festival|food truck rally|food truck night|food truck friday|mobile food|downtown.*food/i },
